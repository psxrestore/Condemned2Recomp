...
# Codegen target - run 'cmake --build . --target condemned2recomp_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(condemned2recomp_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/condemned2recomp_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for condemned2recomp"
    VERBATIM
)
