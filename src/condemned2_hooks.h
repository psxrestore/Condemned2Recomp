...
namespace Condemned2 {
    ...
    static std::vector<std::pair<std::string, HookCallback>> _callBacks = { 
        {"condemned2_maxfps", {200.0, 0x29292864C} }, 
        {"condemned2_fov", {0.01745329238474369, 0x29209C2AC} },
        {"condemned2_update_rate", {60.0, 0x292013B14} },
    };

    static std::vector<std::pair<std::string, uint32_t>> _newSettings = { 
        {"condemned2_body_cap_total_count", 0x820143f0}, 
        {"condemned2_body_cap_radius_count", 0x82014404}, 
        {"condemned2_body_cap_radius", 0x82014418},
    };
}